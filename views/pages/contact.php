...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="Contact us to send your feedback, questions, or inquiries. We’re here to help you with any support you need.">
    <meta name="keywords" content="contact, feedback, support, help, inquiries, email, phone">
...
<body>
    ...
    <?php include '../partials/navbar.php'; ?>
        ...
        <?php if (isset($_SESSION['success'])): ?>
            <div class="alert success-message" id="success-message"><?php echo $_SESSION['success']; unset($_SESSION['success']); ?></div>
        <?php endif; ?>
