...
// Fetch user data
$stmt = $pdo->prepare("SELECT c.* FROM classrooms AS c WHERE c.visibility = 'public' AND c.classroom_id NOT IN (SELECT cm.classroom_id FROM classroom_members as cm WHERE cm.user_id = ?) ORDER BY c.members");
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="../includes/join_classroom.php" method="POST">
                            <div class="mb-3">
        ...
        <div class="modal fade" id="createClassroomModal" tabindex="-1" aria-labelledby="createClassroomModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="../includes/create_classroom.php" method="POST">
                            <div class="mb-3">
